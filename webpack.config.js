...
module.exports = {
  ...
  entry: './src/index.js',
  // En este output, es donde vamos a guardar los archivos resultantes cuando hagamos
  //la configuracion
  output: {
    // La instancia resolve nos ayuda a detectar el directorio donde nos encontramos
    //y el directorio donde vamos a guardar los archivos compilados
